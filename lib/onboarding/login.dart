  ...
  child: Center(
    child: SvgPicture.asset(
          ...
          SizedBox(height: 18),
               Center(
                 child: Container(
                    child: Text("Login", style: TextStyle(fontSize: 33, fontWeight: FontWeight.bold),),
                  ),
               ),
          ...
          Row(            
            ...
            children: [
              Text('Dont have an account yet?',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.grey[850]),),
              TextButton(onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) => Signup()),);
                
              }, child: Text('Sign up',style: TextStyle(fontWeight: FontWeight.bold),),style: TextButton.styleFrom(
